...
export const SudokuBoard: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="glass-panel p-1.5 sm:p-3 rounded-2xl shadow-2xl border-2 border-slate-200 dark:border-slate-700/60 max-w-[98vw] xs:max-w-[480px] sm:max-w-[540px] w-full mx-auto"
    >
